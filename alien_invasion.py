...
class AlienInvasion:
    ...
    def run_game(self):
        ...
        while True:
            ...
            # Redraw screen after everything within the game is updated
            self._update_screen()
    ...
    def _fire_bullet(self):
        '''Create a new bulllet and add it to the bullets group.'''
    ...
    def _check_bullet_alien_collisions(self):
        ...
        # Remove aliens that have collided with bullets.
        # Bullet may or may not disappear (random power-up).
